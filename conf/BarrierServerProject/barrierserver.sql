...
insert  into `tasks`(`id`,`barcode`,`group`,`text`,`user_id`,`priority`) values (4,'544900000028',1,'Товар долго не продается.Число дней: 30',0,1),(5,'481006400232',1,'Товар долго не продается.Число дней: 11',0,1),(6,'460704243877',1,'Товар долго не продается.Число дней: 70',0,1),(7,'481041003192',1,'Товар долго не продается.Число дней: 70',0,1);
...
insert  into `users`(`id`,`username`,`hash`,`group`,`status`,`ip`,`tasks_count`) values (1,'partizanes','1ed6ad31cf5f6e0d10e18f8db3f08c9f',2,0,'127.0.0.1',0);
