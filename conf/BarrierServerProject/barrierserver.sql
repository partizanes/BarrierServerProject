...
insert  into `message`(`userid`,`msg_priority`,`msg_color`,`msg`,`msg_datetime`) values (2,3,'ffff0080','бл..-бл..-бл..))))))))))))))','2013-04-05 14:55:42'),(2,2,'ff00ff40','длпвоорор','2013-04-05 14:57:25'),(2,3,'Aqua','дооолололошошщ','2013-04-05 14:58:49');
...
insert  into `priority`(`id`,`bar`,`name`,`turn_price`,`count`,`sailed`,`status`,`status_text`,`current_price_ukm`,`date`) values (14,'04377','С/М ШАМПИНЬОНЫ РЕЗАНЫЕ ВЕС.',18900,16.000,39.722,3,'',18900,'2013-04-01 14:11:31'),(15,'460562700586','ПРОД.ЙОГУРТН.2.5% ФРУТТИС КЛУБНИКА 115Г',3650,18.000,41.000,3,'',3200,'2013-03-23 14:11:31'),(16,'460562700588','ПРОД.ЙОГУРТН.2.5% ФРУТТИС ПЕРСИК/МАРАК. ',3650,6.000,52.000,3,'',3200,'2013-03-23 14:11:31'),(17,'590112601101','СЫР ПЛАВЛ.СЛИВОЧНЫЙ 40%  140Г',13000,3.000,1.000,0,'',13000,'2013-03-23 14:11:31'),(18,'590112601056','СЫР ПЛАВЛ.С ВЕТЧИНОЙ 40%  140Г',13000,2.000,NULL,1,'',13000,'2013-03-23 14:11:31'),(19,'590112601198','СЫР ПЛАВЛ.40% С ДОБ.СЫРА  ГОУДА 140Г',13000,4.000,2.000,0,'',13000,'2013-03-23 14:11:31');
...
insert  into `version`(`id`,`name`,`ver`,`source`) values (1,'PrioritySales',1,'\\\\192.168.1.11\\update\\PrioritySales.exe');
