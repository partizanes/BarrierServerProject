...
insert  into `users`(`id`,`username`,`hash`,`group`,`status`,`ip`,`tasks_count`) values (1,'partizanes','1ed6ad31cf5f6e0d10e18f8db3f08c9f',2,0,'127.0.0.1',0),(4,'user','91ff7d7746319a2d34f93537c3e54173',1,1,'127.0.0.1',0);
